...
def words_per_minute_mode():
    ...
    Prompts the player to press ENTER to start.
    Then starts the countdown and calls game master function `gm()` with
    parameter '1' = words per minute mode
    """
...
def difficulty_chooser():
    ...
    At the end returns opponent words per minute.
    """
